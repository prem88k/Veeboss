...
class AllJobsDetails extends StatefulWidget {
  const AllJobsDetails({Key? key}) : super(key: key);

  @override
  State<AllJobsDetails> createState() => _AllJobsDetailsState();
}

class _AllJobsDetailsState extends State<AllJobsDetails> {
