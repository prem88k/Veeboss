...
class ProfileJobDetailsAgent extends StatefulWidget {
  jobList jobListData;
  ProfileJobDetailsAgent(this.jobListData);

  @override
  State<ProfileJobDetailsAgent> createState() => _ProfileJobDetailsAgentState();
}

class _ProfileJobDetailsAgentState extends State<ProfileJobDetailsAgent> {
  bool isVisible = true;
      ...
      body: Stack(
        children: [
          SingleChildScrollView(
            child: Padding(
              padding: EdgeInsets.only(top: size.height*0.025, bottom: size.height*0.1,left: size.width*0.050,right:  size.width*0.045),
              child: Column(
                        ...
                        child: Padding(
                          ...
                          child:  Row(
                            ...
                            children: [
                              ...
                              Text(widget.jobListData.workingDays == null ?
                              "-"
