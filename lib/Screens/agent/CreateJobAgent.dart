...
class CreateJobAgent extends StatefulWidget {

  @override
  State<CreateJobAgent> createState() => _CreateJobAgentState();
}

class _CreateJobAgentState extends State<CreateJobAgent> {
  ...
  void checkValidation() {
    if (_titleController.text.isEmpty) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) {
            return CreateJobAgentNextPage(_image!=null ? _image! : File(""), _titleController.text,
