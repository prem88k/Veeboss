...
import 'package:flutter/material.dart';
import 'package:veeboss/Screens/Employer/CreateJobEmployerNextPage.dart';
...
class CreateJobEmployerNext extends StatefulWidget {
  File image;
  String title, category, vacancy, locality, gender;
  CreateJobEmployerNext(this.image,this.title, this.category, this.vacancy, this.locality, this.gender,);

  @override
  State<CreateJobEmployerNext> createState() => _CreateJobEmployerNextState();
}

class _CreateJobEmployerNextState extends State<CreateJobEmployerNext> {
  ...
  @override
  void initState() {
    _qualification = ['10th Pass', '12th Pass', '10 + 12 Pass',  'Diploma',
      'Graduate', 'Post Graduate' , 'Any Other Graduate'];
  ...
  void checkValidation() {
    if (selectedMaxExp.isEmpty) {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) {
                return CreateJobEmployerNextPage(widget.title,widget.category, widget.vacancy, widget.locality, widget.image, widget.gender,
