...
class EmployerAppAnalystPage extends StatefulWidget {
  const EmployerAppAnalystPage({Key? key}) : super(key: key);

  @override
  State<EmployerAppAnalystPage> createState() => _EmployerAppAnalystPageState();
}

class _EmployerAppAnalystPageState extends State<EmployerAppAnalystPage> {
