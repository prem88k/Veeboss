...
class CreateJobVendorNextPage extends StatefulWidget {
  ...
  CreateJobVendorNextPage(this.title, this.category, this.vacancy, this.locality,this.image, this.gender,
  ...
  @override
  State<CreateJobVendorNextPage> createState() => _CreateJobVendorNextPageState();
}

class _CreateJobVendorNextPageState extends State<CreateJobVendorNextPage> {
