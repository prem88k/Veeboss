...
import 'package:veeboss/Screens/Employee/JobProcessScreen.dart';

import '../../ProfileJobDetails.dart';
import '../Employer/EmployerProfilePage.dart';

class NotificationJobDetails extends StatefulWidget {
  String? jobId;

  NotificationJobDetails(this.jobId);

  @override
  _NotificationJobDetailsPageState createState() =>
      _NotificationJobDetailsPageState();
}

class _NotificationJobDetailsPageState extends State<NotificationJobDetails>
                                                                ...
                                                                children: [
                                                                  GestureDetector(
                                                                      ...
                                                                      child: jobListData[index].profilePhoto ==
                                                                          ...
                                                                          : Container(alignment: Alignment.topCenter, height: size.height * 0.080, width: size.height * 0.080, decoration: BoxDecoration(borderRadius: BorderRadius.circular(100), image: DecorationImage(image: NetworkImage(jobListData[index].profilePhoto.toString()), fit: BoxFit.fill)))),
                                                                  SizedBox(
                                                                    width: size
                                                                            .width *
                                                                        0.030,
                                                                      ...
                                                                      children: [
                                                                          ...
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              child: Text(
                                                                                ...
                                                                                style: TextStyle(fontFamily: 'railway', fontSize: size.width * 0.036, fontWeight: FontWeight.bold, color: appButton),
                                                                              ),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              'Vacancy: ',
                                                                              style: TextStyle(fontFamily: 'railway', fontSize: size.width * 0.028, fontWeight: FontWeight.bold, color: appText),
                                                                            ),
                                                                            SizedBox(
                                                                            ...
                                                                            Text(
                                                                              ...
                                                                              style: TextStyle(fontFamily: 'railway', fontSize: size.width * 0.028, fontWeight: FontWeight.normal, color: appText),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ],
                                                              ...
                                                              Text(
                                                                jobListData[index]
                                                                    ...
                                                                    ? jobListData[index]
                                                                        .appliedTime
                                                                        .toString()
                                                                    : jobListData[index].companyStatus ==
                                                                                "selected" &&
                                                                            jobListData[index].comShortlistStatus ==
                                                                                null
                                                                        ? jobListData[index]
                                                                            .hrTime
                                                                            .toString()
                                                                        : jobListData[index].comShortlistStatus == "accepted" &&
                                                                                jobListData[index].hiringStatus == null
                                                                            ? jobListData[index].companyShortlistTime.toString()
                                                                            : jobListData[index].hiringStatus == "hired"
                                                                                ? jobListData[index].hiringTime.toString()
  ...
  Future<void> getUserLists() async {
    ...
    var uri = Uri.https(
      'yourang.shop',
      '/veeboss/public/api/v1/job/getMyAppliedJobsnoti',
    );
    final headers = {
